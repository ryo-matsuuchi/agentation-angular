...
export declare class IconComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<IconComponent, "agentation-icon", never, { "data": { "alias": "data"; "required": true; }; "size": { "alias": "size"; "required": false; }; }, {}, never, never, true, never>;
}
