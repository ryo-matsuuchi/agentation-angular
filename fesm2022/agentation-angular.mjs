...
import { inject, Input, ChangeDetectionStrategy, Component, EventEmitter, Output, input, signal, effect, ViewChild, ViewEncapsulation, Injectable, computed, NgZone, DestroyRef } from '@angular/core';
...
class IconComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "19.2.18", type: IconComponent, isStandalone: true, selector: "agentation-icon", inputs: { data: "data", size: "size", variant: "variant" }, ngImport: i0, template: `
    <svg
      [attr.width]="size"
      [attr.height]="size"
